            ...
            getInstruction(
              ...
              (step4) => {
                ...
                getInstruction(
                  ...
                  (step5) => {
                    document.querySelector("#mashedPotatoes").innerHTML +=
                      `<li>${step5}</li><li>Mashes potatoes are ready!</li>`;
                    document
            ...
            obtainInstruction("steak", 6).then((step7) => {
              ...
              obtainInstruction("steak", 7).then((step8) => {
                document.querySelector("#steak").innerHTML +=
                  `<li>${step8}</li><li>Steak is Ready!</li>`;
...
async function makeBroccoli() {
  ...
  document.querySelector("#broccoli").innerHTML +=
    `<li>${step7}</li><li>Broccoli is ready!</li>`;
...
Promise.all([
  ...
  document.querySelector("#brusselsSprouts").innerHTML +=
    `<li>${values[6]}</li>`;
  document.querySelector("#brusselsSprouts").innerHTML +=
    `<li>${values[7]}</li><li>Brussel sprouts are ready!</li>`;
